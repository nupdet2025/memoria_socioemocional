...
{for(var i = 0, len = gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.FlashContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.FlashContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setStartingOpacity((gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.FlashContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Opacity")).getOpacity()));
}
}{for(var i = 0, len = gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.FlashContext.GDObjectObjects1.length ;i < len;++i) {
...
{for(var i = 0, len = gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.FlashContext.GDObjectObjects1.length ;i < len;++i) {
    ...
    gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.FlashContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setFlashDuration(eventsFunctionContext.getArgument("NewFlashDuration"));
}
}{for(var i = 0, len = gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.FlashContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.FlashContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setTargetOpacity(eventsFunctionContext.getArgument("NewTargetOpacity"));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.SetHalfPeriodTimeContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.SetHalfPeriodTimeContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setHalfPeriodTime(eventsFunctionContext.getArgument("Value"));
}
}}
