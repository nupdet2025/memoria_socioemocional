...
for (var i = 0, k = 0, l = gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3.length;i<l;++i) {
    if ( gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3[i].getVariableString(gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3[i].getVariables().get("checkSom")) == "som0" ) {
...
{gdjs.evtTools.sound.playSound(runtimeScene, "assets\\audio_hit.mp3", false, 100, 1);
}{gdjs.evtTools.sound.playSound(runtimeScene, "assets\\btn_hit.mp3", false, 60, 1);
}}
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3.length;i<l;++i) {
    if ( gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3[i].getVariableString(gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3[i].getVariables().get("checkSom")) == "som7" ) {
        isConditionTrue_0 = true;
        gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3[k] = gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3[i];
        ++k;
    }
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3.length;i<l;++i) {
    if ( gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3[i].getVariableString(gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3[i].getVariables().get("checkSom")) == "som8" ) {
        isConditionTrue_0 = true;
        gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3[k] = gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3[i];
        ++k;
    }
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3.length;i<l;++i) {
    if ( gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3[i].getVariableString(gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3[i].getVariables().get("checkSom")) == "som9" ) {
        isConditionTrue_0 = true;
        gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3[k] = gdjs.evtsExt__Card__ExplodeCard.GDCardObjects3[i];
        ++k;
    }
